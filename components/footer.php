<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="#"><i class="fas fa-envelope"></i>rezaavicenna@gmail.com</a>
         <a href="#"><i class="fas fa-map-marker-alt"></i> jakarta selatan 12450 </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span> Toko Buku Indah Jaya </span> | all rights reserved!</div>
